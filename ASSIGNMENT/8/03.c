...
{
    if(q->front==NULL){push_back(q,k); return;}
	struct node* temp = newNode(k);
	struct node* temp2;
...
int main()
{
	...
	printf("This is a program to demonstrate Doubly Linked List.\n\n");

    while(2>1)
    {
        printf("Press 1 to Insert a element in Doubly Linked List.\n");
        printf("Press 2 to Delete a element in Doubly Linked List.\n");
        printf("Press 3 to Display Doubly Linked List.\n");
