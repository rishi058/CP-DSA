...
\newcommand{\emailb}{officialemail@iiitbh.ac.in} %Email 2
...
\parbox{2.35cm}{%
\includegraphics[width=2cm,clip]{college_logo.png}
}
...
\begin{tabularx}{\linewidth}{L r} \\
  ...
  {Indian Institute Of Information Technology, Bhagalpur} & \href{https://www.yourLinkedinProfile.com/in/}{\raisebox{0.0\height}{\footnotesize \faLinkedin}\ {LinkedIn Profile}}
\end{tabularx}
}
% \parbox{3.0cm}{%
...
\section{\textbf{Education}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Your School Name, 12th}{CGPA/Percentage: xxx}
      {Board of Intermediate Education, State}{Year}
    \resumeSubheading
      {Your School name, 10th}{CGPA/Percentage: xxx}
